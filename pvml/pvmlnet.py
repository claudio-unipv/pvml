...
_MEAN = np.array([0.485, 0.456, 0.406]).reshape(1, 1, 1, 3)
_STDDEV = np.array([0.229, 0.224, 0.225]).reshape(1, 1, 1, 3)


######################################################################


_IMAGENET_CLASSES = list(map(str.strip, """
...
class PVMLNet(_CNN):
    ...
    def preprocessing(self, X):
        X = (X - _MEAN) / _STDDEV
        X = np.pad(X, ((0, 0), (16, 16), (16, 16), (0, 0)))
        return X
